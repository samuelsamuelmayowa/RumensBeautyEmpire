...
import img1 from "../assets/images/main/WhatsApp Image 2026-06-09 at 7.12.26 PM (2).jpeg";
import img2 from "../assets/images/main/wigone.jpeg";
import img3 from "../assets/images/main/WhatsApp Image 2026-06-09 at 7.12.26 PM (6).jpeg";
import img4 from "../assets/images/main/WhatsApp Image 2026-06-09 at 7.12.23 PM (3).jpeg";
      ...
      <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <p className="mt-6 text-gray-600 text-lg leading-relaxed max-w-xl">
            ...
            designed to enhance your beauty, protect your natural hair, and give
            you confidence that lasts long after you leave our chair.
          </p>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative h-[600px] overflow-hidden rounded-[2.5rem] shadow-[0_20px_60px_rgba(0,0,0,0.15)]">
          ...
          <div className="absolute -bottom-10 -left-10 hidden h-72 w-56 overflow-hidden rounded-[2rem] border-8 border-white shadow-2xl md:block">
            <AnimatePresence mode="wait">
              <motion.img
                key={`small-${current}`}
                src={slides[(current + 1) % slides.length]}
                alt="Premium hairstyle preview"
          ...
          <div className="absolute top-8 right-8 bg-white border border-gray-200 rounded-3xl p-6 shadow-xl">
            <h3 className="text-4xl font-extrabold text-text_gold">100%</h3>
            <p className="text-gray-700 font-medium">Beauty & Confidence</p>
          </div>
